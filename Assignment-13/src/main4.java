...
class Calculator implements ActionListener {
    ...
    Calculator() {
        ...
        l1.setBounds(50, 100, 116, 20);
        l2.setBounds(50, 150, 116, 20);
        l3.setBounds(50, 200, 100, 20);
        t1.setBounds(200, 100, 100, 20);
        t2.setBounds(200, 150, 100, 20);
        t3.setBounds(200, 200, 100, 20);
        b1.setBounds(50, 250, 56, 20);
        b2.setBounds(110, 250, 56, 20);
        b3.setBounds(170, 250, 56, 20);
        b4.setBounds(230, 250, 56, 20);
        f.add(l1);
        f.add(l2);
        f.add(l3);
        f.add(t1);
